/**
 * Taken from THREE.JS (r47) -- Credits below:
...
Matrix4.prototype = {
	...
	lookAt: function ( eye, center, up ) {
		...
		var x = Matrix4.__v1, y = Matrix4.__v2, z = Matrix4.__v3;
	...
	getPosition: function () {
		...
		return Matrix4.__v1.set( this.n14, this.n24, this.n34 );

	},

	getColumnX: function () {

		return Matrix4.__v1.set( this.n11, this.n21, this.n31 );

	},

	getColumnY: function () {

		return Matrix4.__v1.set( this.n12, this.n22, this.n32 );

	},

	getColumnZ: function() {

		return Matrix4.__v1.set( this.n13, this.n23, this.n33 );
